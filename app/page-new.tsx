...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-forest-50 via-background to-green-olive-50">
        ...
        <nav className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a
                href="#features"
                className="text-white/90 hover:text-green-olive-300 transition-colors duration-300 font-medium"
              >
                Features
              </a>
              <a
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="text-center animate-on-scroll">
                <div className="text-3xl font-bold text-green-forest-600 mb-2">
                  {stat.number}
                </div>
                <div className="text-green-forest-500 font-medium">
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="group p-8 bg-gradient-to-br from-green-forest-50 to-white rounded-2xl border border-green-forest-100 hover:border-green-olive-300 transition-all duration-300 hover:shadow-xl hover:transform hover:scale-105 animate-on-scroll"
              >
                ...
                <h3 className="text-xl font-bold text-green-forest-800 mb-4">
                  {feature.title}
                </h3>
                <p className="text-green-forest-600 leading-relaxed">
                  {feature.description}
                </p>
              </div>
            ))}
      ...
      <section
        id="how-it-works"
        className="py-20 bg-gradient-to-br from-green-forest-50 to-green-olive-50"
      >
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 animate-on-scroll">
            <h2 className="text-4xl md:text-5xl font-bold text-green-forest-800 mb-4">
      ...
      <footer className="bg-green-forest-900 text-white py-16">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="animate-on-scroll">
              <h4 className="text-lg font-semibold mb-4 text-green-olive-300">
                Platform
              </h4>
          ...
          <div className="border-t border-white/20 pt-8 text-center text-white/60 animate-on-scroll">
            ...
            <p className="mt-2">
              ...
              <a
                href="#"
                className="hover:text-green-olive-300 transition-colors ml-2"
              >
                Terms of Service
              </a>{" "}
              •
