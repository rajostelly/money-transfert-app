  ...
  return (
    <Card className="shadow-sm hover:shadow-md transition-shadow">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        <CardTitle className="text-lg font-semibold">{transfer.beneficiary.name}</CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="font-medium">{transfer.amountMGA.toLocaleString()} MGA</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <p className="font-medium">{format(new Date(transfer.createdAt), "MMMM dd, yyyy")}</p>
          </div>
        </div>
        ...
        {transfer.status === "COMPLETED" && transfer.confirmedAt && (
          <div className="pt-2 border-t">
            ...
            <p className="font-medium text-emerald-600">
              {format(new Date(transfer.confirmedAt), "MMMM dd, yyyy 'at' HH:mm")}
            </p>
          </div>
        )}
